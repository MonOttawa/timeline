...
const TimelineGenerator = () => {
  ...
  const parseMarkdown = (markdownContent) => {
    const rawEvents = markdownContent.split('---').filter(event => event.trim() !== '');
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-white dark:bg-gray-800 p-8 mb-8 text-center border-4 border-black dark:border-white shadow-[8px_8px_0px_#000] dark:shadow-[8px_8px_0px_#FFF] rounded-lg">
        <h1 className="text-4xl font-black mb-4 font-display">My Project Timeline</h1>
      ...
      {events.length > 0 && (
        ...
        >
          {/* Vertical Line */}
          <div className="absolute left-10 top-8 bottom-8 w-0.5 bg-black dark:bg-white"></div>
