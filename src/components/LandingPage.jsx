    ...
    return (
        <div>
            ...
            <header className="py-24 text-center">
                ...
                <p className="text-xl md:text-2xl max-w-2xl mx-auto mb-12 text-gray-600 dark:text-gray-300 font-sans">
            ...
            <footer className="py-12 border-t-4 border-black dark:border-white mt-12 bg-white dark:bg-gray-900">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="text-left">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 font-medium">&copy; 2025. All rights reserved.</p>
                    </div>
                    <button
                        onClick={onShowLegal}
