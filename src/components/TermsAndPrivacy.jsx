...
const TermsAndPrivacy = ({ onBack }) => {
    return (
        <div className="max-w-4xl mx-auto py-8">
            <button
                onClick={onBack}
                className="mb-8 flex items-center gap-2 px-4 py-2 border-2 border-black border-white font-bold rounded-lg shadow-[4px_4px_0px_#000] shadow-[4px_4px_0px_#FFF] hover:bg-black hover:bg-white hover:text-white hover:text-black transition-all"
            >
                <ArrowLeft size={20} />
                Back to Home
            </button>

            <div className="bg-white bg-gray-800 p-8 border-4 border-black border-white shadow-[8px_8px_0px_#000] shadow-[8px_8px_0px_#FFF] rounded-lg mb-8">
